  ...
  <div className="grid grid-cols-2">
    ...
    >
      ...
      {loading ? (
        ...
        <div className="p-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-[1400px] mx-auto">
          {tiers.map((tier) => (
            <div key={tier} className="bg-[#111] border border-[#222] rounded-xl p-3 min-h-[480px]">
