  ...
  return (
    <main className="bg-[#0b0b0b] min-h-screen text-white font-sans">
      ...
      <div className="w-full bg-[#0d0d0d] px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between border-b border-[#222] gap-4 sm:gap-0">
        <Image src={logo} alt="Logo" width={180} height={50} className="mx-auto sm:mx-0" />
        ...
        <div className="flex items-center gap-4 flex-wrap justify-center sm:justify-start">
          ...
          <a href="https://discord.gg/XgKWMDzWbz" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 bg-[#7289da] hover:bg-[#5b6eae] px-3 py-1 rounded-md font-bold transition">
      ...
      <div className="w-full px-4 sm:px-6 mt-6 flex flex-col sm:flex-row justify-between gap-2 flex-wrap">
        ...
        <div className="flex flex-row gap-2 flex-wrap">
          <div className="bg-[#111] border border-[#222] rounded-md px-8 sm:px-12 py-2 text-base cursor-pointer hover:bg-[#1a1a1a] transition animate-fadeInUp relative"
            ...
            {infoOpen && (
              <div className="absolute top-full mt-2 left-0 w-[260px] bg-[#111] border border-[#222] rounded-md p-3 z-50 shadow-lg text-sm">
                <ul className="space-y-1 text-white">
                  <li><span className="font-bold text-yellow-400">Crystal GrandMaster:</span> Top 1</li>
                  <li><span className="font-bold text-gray-300">Crystal Master:</span> Top 2-4</li>
                  <li><span className="font-bold text-[#CD7F32]">Crystal Ace:</span> Top 5-7</li>
                  <li><span className="font-bold text-gray-700">Crystal Pro:</span> Top 8-10</li>
                </ul>
              </div>
            )}
          </div>
      ...
      {loading ? (
        ...
        <div className="max-w-full mx-auto flex flex-col gap-3 p-4 sm:p-8">
          {players.map((p, i) => (
            ...
            >
              <div className={`flex items-center justify-center font-bold text-lg ${getNumberBoxStyle(i)}`}
                   style={{ width: "90px", minHeight: "60px", clipPath: "polygon(0 0, 90% 0, 100% 50%, 90% 100%, 0 100%)", position: "relative", overflow: "hidden", zIndex: 10 }}>
                {i + 1}
              </div>
      ...
      {selectedPlayer && (
        <div className="fixed inset-0 backdrop-blur-md bg-black/40 flex items-center justify-center z-50 p-4"
          ...
          <div className="bg-[#111] border border-[#222] rounded-2xl shadow-xl px-6 py-5 flex flex-col items-center gap-3 w-full max-w-[320px]"
